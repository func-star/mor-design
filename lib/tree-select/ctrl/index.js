...
var TreeSelectCtrl = function (_CtrlBase) {
	_inherits(TreeSelectCtrl, _CtrlBase);

	function TreeSelectCtrl() {
		var _ref;

		var _temp, _this, _ret;

		_classCallCheck(this, TreeSelectCtrl);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TreeSelectCtrl.__proto__ || Object.getPrototypeOf(TreeSelectCtrl)).call.apply(_ref, [this].concat(args))), _this), _this.expandedKeys = [], _temp), _possibleConstructorReturn(_this, _ret);
	}

	_createClass(TreeSelectCtrl, [{
		key: 'setDefaultValue',
	...
	return TreeSelectCtrl;
}(CtrlBase);

exports.default = TreeSelectCtrl;