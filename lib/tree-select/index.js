...
var TreeSelect = function (_Component) {
	...
	_createClass(TreeSelect, [{
		...
		value: function render() {
			...
			if (multiple) {
				return _react2.default.createElement(_multiple2.default, _extends({}, props, { ref: 'sel' }));
			} else {
				return _react2.default.createElement(_single2.default, _extends({}, props, { ref: 'sel' }));
			}
		}
	}]);
